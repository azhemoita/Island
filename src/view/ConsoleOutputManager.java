    ...
    public void printIslandState() {
        ...
        for (int x = 0; x < width; x++) {
            ...
            for (int y = 0; y < height; y++) {
                ...
                long ducks = cell.getAnimals().stream().filter(Duck.class::isInstance).count();
                countOfDucks += ducks;
                long wolves = cell.getAnimals().stream().filter(Wolf.class::isInstance).count();
                countOfWolves += wolves;
                int plants = cell.getPlants().size();
                countOfPlants += plants;
                long caterpillar = cell.getAnimals().stream().filter(Caterpillar.class::isInstance).count();
                countOfCaterpillars += caterpillar;
                long horse = cell.getAnimals().stream().filter(Horse.class::isInstance).count();
                countOfHorses += horse;
                long deer = cell.getAnimals().stream().filter(Deer.class::isInstance).count();
                countOfDeers += deer;
                long buffalo = cell.getAnimals().stream().filter(Buffalo.class::isInstance).count();
                countOfBuffalo += buffalo;
                long hare = cell.getAnimals().stream().filter(Hare.class::isInstance).count();
                countOfHares += hare;
                long boar = cell.getAnimals().stream().filter(Boar.class::isInstance).count();
                countOfBoars += boar;
                long hamster = cell.getAnimals().stream().filter(Hamster.class::isInstance).count();
                countOfHamsters += hamster;
                long sheep = cell.getAnimals().stream().filter(Sheep.class::isInstance).count();
                countOfSheep += sheep;
                long goat = cell.getAnimals().stream().filter(Goat.class::isInstance).count();
                countOfGoats += goat;
                long snake = cell.getAnimals().stream().filter(Snake.class::isInstance).count();
                countOfSnakes += snake;
                long eagle = cell.getAnimals().stream().filter(Eagle.class::isInstance).count();
                countOfEagles += eagle;
                long fox = cell.getAnimals().stream().filter(Fox.class::isInstance).count();
                countOfFoxes += fox;
                long bear = cell.getAnimals().stream().filter(Bear.class::isInstance).count();
                countOfBears += bear;
